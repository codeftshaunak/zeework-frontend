        ...
        (isClient && <ClientSignUp />) || (
          ...
          >
            <HStack
              ...
              className="max-sm:!flex-col max-sm:!w-full"
            >
              <Box
...
export const FreelancerSignUp = () => {
  ...
  useEffect(() => {
    // add by default role of freelancer
    setValue("role", 1);
      ...
      {verifyShow ? (
        <>
          <OnbardingCardLayout width="600px">
            <VStack gap={"5"} className="max-sm:!w-full">
              <VStack gap={"5"}>
                <Box
              ...
              <Box display={"grid"} gap={"5"}>
                ...
                <Stack gap={0}>
                  <Select
                    ...
                    options={countries}
                    onChange={(data) => {
                      setValue("country", data.name), trigger("country");
                    }}
      ...
      <VStack gap={"5"}>
        <VStack gap={"5"}>
          ...
          <Text textAlign="center">
            ...
            <br />
            Please check your email and click on the link provided <br /> to
            verify your address
          </Text>
        </VStack>
